    ...
    public class ProductSeed : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            builder.HasData(
                ...
                new Product { Id = 4, CategoryId = 2, Name = "Kitap 1", Price = 200, Stock = 70, CreatedDate = DateTime.Now },
                new Product { Id = 5, CategoryId = 2, Name = "Kitap 2", Price = 250, Stock = 80, CreatedDate = DateTime.Now });
        }
    }
}
